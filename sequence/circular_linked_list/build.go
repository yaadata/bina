...
// NewComparableInterfaceBuilder returns a [Builder] for creating a [collection.LinkedList] with [compare.Comparable] elements.
func NewComparableInterfaceBuilder[T compare.Comparable[T]]() Builder[T, collection.LinkedList[T, collection.DoublyLinkedListNode[T]], *comparableBuilder[T]] {
