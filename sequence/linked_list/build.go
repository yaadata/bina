...
func (b *builtinBuilder[T]) Build() collection.LinkedList[T, collection.SinglyLinkedListNode[T]] {
...
func (b *comparableBuilder[T]) Build() collection.LinkedList[T, collection.SinglyLinkedListNode[T]] {
