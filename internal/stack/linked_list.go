...
func ___[T comparable]() {
	var _ collection.Stack[T] = (*linkedListStack[T])(nil)
}
...
func LinkedListStackFromBuiltin[T comparable](inner collection.LinkedList[T, collection.SinglyLinkedListNode[T]]) *linkedListStack[T] {
	return &linkedListStack[T]{inner: inner}
}

func LinkedListStackFromComparable[T compare.Comparable[T]](inner collection.LinkedList[T, collection.SinglyLinkedListNode[T]]) *linkedListStack[T] {
	return &linkedListStack[T]{inner: inner}
}
