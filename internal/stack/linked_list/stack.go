...
func StackFromBuiltin[T comparable](inner sequence.LinkedList[T, sequence.SinglyLinkedListNode[T]]) *stack[T] {
	return &stack[T]{inner: inner}
}

func StackFromComparable[T compare.Comparable[T]](inner sequence.LinkedList[T, sequence.SinglyLinkedListNode[T]]) *stack[T] {
	return &stack[T]{inner: inner}
}
